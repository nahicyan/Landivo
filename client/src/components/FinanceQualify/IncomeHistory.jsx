...
export default function IncomeHistory({ surveyData, updateSurveyData, onNext, onBack }) {
  // Handle selection
  const handleSelection = (choice) => {
    updateSurveyData("income_history", choice);
    
    // Set disqualification flag if no 2-year income history
    if (choice === "No") {
  ...
  const translations = {
    ...
    es: {
      title: "¿Tiene un historial de ingresos de 2 años y puede ser documentado?",
      yes: "Sí",
      no: "No",
      back: "Atrás"
    }
